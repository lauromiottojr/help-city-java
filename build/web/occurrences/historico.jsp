    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="material-icons">history</i> Histórico de Ocorrências
                </li>
            </ol>
        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                    <tr>
                                        ...
                                        <% if (typeUser.equalsIgnoreCase("B")) { %><th>Secretaria</th><% }%>
                                        <th>Status</th>
                                        <th>Opções</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <c:forEach var="ocorrencia" items="${ocorrencias}">
                                        <tr>
                                            ...
                                            <td>${ocorrencia.categoriaOcorrencia.nomeCategoria == null ? '-' : ocorrencia.categoriaOcorrencia.nomeCategoria}</td>
                                            ...
                                            <% if (typeUser.equalsIgnoreCase("B")) { %><td>${ocorrencia.secretariaOcorrencia.nomeSecretaria == null ? '-' : ocorrencia.secretariaOcorrencia.nomeSecretaria}</td><% }%>

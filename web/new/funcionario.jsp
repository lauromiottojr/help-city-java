    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="material-icons">assignment</i> Cadastrar Funcionário
                </li>
            </ol>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="demo-masked-input">
                            <div class="row clearfix">
                                <form id="formCadastro" name="formCadastro" action="<%= request.getContextPath()%>/newemployee" method="POST">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control show-tick" data-live-search="true" name="secretariaFuncionario" id="secretariaFuncionario">                                               
                                                <c:forEach var="secretaria" items="${secretarias}">
                                                    <option value="${secretaria.idSecretaria}">${secretaria.nomeSecretaria}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>  

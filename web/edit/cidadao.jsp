    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<%= request.getContextPath()%>/citizens"><i class="material-icons">search</i> Consultar Cidadão</a>
                </li>
                <li class="active">
                    <i class="material-icons">edit</i> Alterar Cidadão
                </li>
            </ol>
        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line" id="grpRg">
                                                <input type="text" class="form-control" name="rgUsuario" id="rgUsuario" placeholder="Inserir sem pontuação" onkeydown="javascript: fMasc(this, mRg);" value="${cidadao.rgUsuario}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">

...
@WebServlet(name = "ListarFuncionario", urlPatterns = {"/employees"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (tipoUsuario.equalsIgnoreCase("A")) {
                ...
                request.setAttribute("funcionarios", dao.listarCidade(idCidade));
            }
            request.getRequestDispatcher("consult/funcionario.jsp").forward(request, response);

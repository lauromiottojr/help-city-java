...
@WebServlet(name = "AlterarSenhaUsuarios", urlPatterns = {"/edituserpassword"})
public class AlterarSenhaUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (tipoUsuario.equalsIgnoreCase("A")) {
                ...
                if (tipoUsuarioAlter.equalsIgnoreCase("B")) {
                    request.getRequestDispatcher("admprefs").forward(request, response);
                } else if (tipoUsuarioAlter.equalsIgnoreCase("C")) {
                    request.getRequestDispatcher("employees").forward(request, response);
                } else if (tipoUsuarioAlter.equalsIgnoreCase("D")) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AlterarSenhaUsuarios.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

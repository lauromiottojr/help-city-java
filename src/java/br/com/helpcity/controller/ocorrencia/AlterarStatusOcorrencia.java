...
@WebServlet(name = "AlterarStatusOcorrencia", urlPatterns = {"/occurrencestatus"})
public class AlterarStatusOcorrencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.alterarStatus(ocorrencia)) {
                ...
                mensagem = "<div class=\"alert alert-danger alert-dismissible\" role=\"alert\">\n"
                        + "                                <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n"
                        + "                                Problemas ao cancelar Ocorrência. Verifique os dados informados e tente novamente!\n"
                        + "                            </div>";
            }
            ...
            System.out.println("Problemas no Servlet ao alterar Ocorrência! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AlterarStatusOcorrencia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

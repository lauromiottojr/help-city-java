...
@WebServlet(name = "ListarCidadeEstado", urlPatterns = {"/ListarCidadeEstado"})
public class ListarCidadeEstado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JsonElement jsonobj = gson.toJsonTree(dao.listar(uf));
            obj.add("cidadesestado", jsonobj);

...
@WebServlet(name = "AlterarStatusCidade", urlPatterns = {"/citystatus"})
public class AlterarStatusCidade extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AlterarStatusCidade.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

...
@WebServlet(name = "ListarCategoria", urlPatterns = {"/categories"})
public class ListarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("categorias", dao.listarCidade(idCidade));
            request.getRequestDispatcher("consult/categoria.jsp").forward(request, response);

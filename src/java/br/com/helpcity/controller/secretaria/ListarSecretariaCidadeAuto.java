...
@WebServlet(name = "ListarSecretariaCidadeAuto", urlPatterns = {"/ListarSecretariaCidadeAuto"})
public class ListarSecretariaCidadeAuto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JsonElement jsonobj = gson.toJsonTree(dao.listarCidade(idCidade));
            obj.add("secretariacidade", jsonobj);

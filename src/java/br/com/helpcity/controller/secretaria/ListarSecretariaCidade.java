...
@WebServlet(name = "ListarSecretariaCidade", urlPatterns = {"/departments"})
public class ListarSecretariaCidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("consult/secretaria.jsp").forward(request, response);
        } catch (Exception ex) {

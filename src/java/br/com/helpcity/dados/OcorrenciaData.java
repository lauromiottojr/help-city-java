...
@WebServlet(name = "OcorrenciaData", urlPatterns = {"/OcorrenciaData"})
public class OcorrenciaData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JsonElement jsonobj = gson.toJsonTree(dao.ocorrenciaDataCidade(request.getParameter("startDate"), request.getParameter("endDate"), idCidade, request.getParameter("status")));
            obj.add("dadosperiodo", jsonobj);

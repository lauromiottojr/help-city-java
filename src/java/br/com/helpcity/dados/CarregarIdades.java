...
@WebServlet(name = "CarregarIdades", urlPatterns = {"/CarregarIdades"})
public class CarregarIdades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JsonElement jsonobj = gson.toJsonTree(dao.countIdade());
            obj.add("dadosidades", jsonobj);

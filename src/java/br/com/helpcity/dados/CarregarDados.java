...
@WebServlet(name = "CarregarDados", urlPatterns = {"/dashboard"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (tipoUsuario.equalsIgnoreCase("A")) {
                request.setAttribute("somas", dao.countDados());
                ...
                request.setAttribute("somascidade", dao.countDadosCidade(idCidade));
